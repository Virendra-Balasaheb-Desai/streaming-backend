...
const addComment = asyncHandler(async (req, res) => {
    ...
    if (!content || !content.trim())
        throw new ApiError(401, "Missing content of comment");
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, comment, "Comment on video successfully."));
});
...
const updateComment = asyncHandler(async (req, res) => {
    ...
    if (!updatedComment)
        throw new ApiError(401, "Unable to update the comment");
